...
@Properties({
        @Property(
                ...
                value = CenterCropImageTransformerImpl.TYPE,
                propertyPrivate = true
        )
})
@Service
public class CenterCropImageTransformerImpl implements ImageTransformer {
    private static  final Logger log = LoggerFactory.getLogger(CenterCropImageTransformerImpl.class);
    ...
    private static final String KEY_CENTERED = "center";
    ...
    public final Layer transform(final Layer layer, final ValueMap properties) {
        ...
        final boolean centered = properties.get(KEY_CENTERED, false);
    ...
    private Rectangle getSmartBounds(
            final int x, final int y, final int width, final int height, final int layerWidth, final int layerHeight) {
